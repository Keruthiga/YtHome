...
function Home() {
  ...
  return (
    <div
      style={{ position: "absolute", left: "2rem", top: "80px", zIndex: "9" }}
      className="main"
    >
      <Filter
